            ...
            options.popup.onShowing = (ev) => {
                ...
                if (this.readOnly) {
                    ...
                    toolbar.push({
                        toolbar: 'bottom',
                        location: 'before',
                        html: '<i style="color:black;display:inline-block" class="material-icons">lock</i> <div style="color:red;display:inline-block;background-color: rgb(255,255,255,0.5);border: 1px solid black;padding-left:10px; padding-right: 10px;">' + this.labelLocalized['cannotModifyExternalData'] + '</div>',
                    });
